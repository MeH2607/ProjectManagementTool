...
VALUES
       ...
       ("Shopping Cart Functionality", "Implementing the shopping cart feature for the website", 10, 2, "2023-08-15", 1, 'TODO'),
       ("User Authentication", "Creating the login and signup functionality for the mobile app", 15, 1, "2023-08-31", 2, 'TODO'),
       ("Bug Fixing", "Fixing bugs in the web app's user interface", 5, 3, "2023-11-30", 3, 'TODO'),
       ("Integration with Payment Gateway", "Implementing the ability to process payments using a third-party payment gateway", 20, 5, "2023-10-31", 4, 'TODO'),
       ("Revamp Product Listings Page", "Redesigning and updating the product listings page of the website", 8, 2, "2023-07-15", 1, 'TODO'),
       ("Market Research for Campaign", "Conducting market research and analysis to determine the target audience and messaging for a new marketing campaign", 30, 7, "2023-09-30", 5, 'TODO'),
       ("User Manual for App", "Creating a user manual and documentation for a new software application", 12, 4, "2023-12-31", 6, 'TODO'),
       ("QA Testing for Website", "Conducting comprehensive quality assurance testing of the website's functionality and user experience", 25, 6, "2023-11-15", 1, 'TODO');
